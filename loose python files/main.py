...
from dbFunctions import add_password, check_existing_entry, delete_entry, get_password, edit_password
from password_generator import password_generator
from dbMemory import get_site, send_to_temp
from first_time import first_time_check, change_first_time 
...
class Register(Frame):
    def __init__(self, master):
        ...
        Label(self, text="Please enter a master password and a username. You should remember these carefully.").pack()
        ...
        Label(self, text="Enter a username of your choice").pack()
        username_entry = Entry(self)
...
class ShowPassword(Frame):
    def __init__(self, master):
        ...
        try:
            ...
            #This large website_text code is due to that it is copyable this way
